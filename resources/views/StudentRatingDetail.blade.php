        ...
        <div class="flex flex-col px-[20%]">
            ...
            <div class="flex flex-row gap-4"> 
              ...
              <div class="flex flex-col">
                <h1 class="font-bold text-[48px] max-w-[480px] leading-tight">{{ $student->Name }}</h1>
            ...
            <div class="flex flex-col gap-y-4 overflow-x-hidden overflow-y-auto w-[760px] h-[310px] my-10 pr-4">
                @foreach ($studentCourse as $c)
                  <a class="w-[710px] h-[63px] bg-white border border-gray-300 flex items-center p-4 justify-between rounded-2xl shadow-md hover:cursor-pointer hover:bg-gray-200" onclick="ChangeValue('{{ $c->Title }}', {{ $c->id }}, {{ $student->id }})">
                      ...
                      <div class="flex flex-row mr-16">
                          <svg class="w-6 h-6 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <p class="text-base ml-2">{{ intval($c->RatingStudent) }}/5</p>                       
                      </div>
                  </a>
                @endforeach
            </div>
            <div class="flex flex-row bg-[#8292AC] w-[710px] h-[63px] items-center space-x-64 p-4 justify-between rounded-2xl">
                ...
                <form method="POST" action="{{ route('UpdateRating', ['StudentID'=>$student->id]) }}" id="RatingForm" class="inline-block relative h-[30px] text-[30px] leading-[30px]">
                    ...
                    <label class="absolute h-full cursor-pointer top-0 left-0 z-[5]">
                      ...
                      <span class="float-left text-transparent"><svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M13.849 4.22c-.684-1.626-3.014-1.626-3.698 0L8.397 8.387l-4.552.361c-1.775.14-2.495 2.331-1.142 3.477l3.468 2.937-1.06 4.392c-.413 1.713 1.472 3.067 2.992 2.149L12 19.35l3.897 2.354c1.52.918 3.405-.436 2.992-2.15l-1.06-4.39 3.468-2.938c1.353-1.146.633-3.336-1.142-3.477l-4.552-.36-1.754-4.17Z"/>
                          </svg></span>
                    </label>
