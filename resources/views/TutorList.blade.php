...
<body>
    ...
    <div class="py-8 px-4 min-h-[90vh] mx-auto max-w-6xl lg:py-16">
        <form method="GET" action="{{ route('TutorListPage') }}">
            ...
            <div class="relative">
                ...
                <input type="search" id="search-course" class="block w-full p-4 ps-10 text-lg text-gray-900 border border-gray-300 rounded-full bg-[#D9D9D9]focus:ring-blue-500 focus:border-blue-500" placeholder="Cari Tutor" name="tutorToFind"/>
        ...
        {{-- <img src="{{ asset('Assets/empty-img/empty-not-found.png')}}" class="object-cover mx-auto h-96 my-20"> --}}
